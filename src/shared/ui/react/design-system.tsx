 ...
 * @property {boolean} [isSpaced] - If true, adds spacing between child elements.
 * @property {string} [lang] - Language attribute for the HTML element.
 * @property {boolean} [suppressHydrationWarning] - If true, suppresses hydration warnings.
 */
